...
بعنوان مثال میتونید در کنار تانل های ریورس مثل Waterwall که هرازچندگاهی کانکشن مختل میشه استغاده کنید تا سرویس Waterwall رو مانیتور کنید تا دستور ریستارت تانل بصورت اتوماتیک اجرا بشه.
